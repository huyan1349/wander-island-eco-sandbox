...
titleCode = titleCode.replace(
    /<span className="text-2xl font-bold tracking-\[0\.2em\] text-white\/80 hand-drawn-title">流浪岛<\/span>/g,
    '<span className="text-2xl font-bold tracking-[0.2em] text-slate-700 hand-drawn-title">流浪岛</span>'
);

titleCode = titleCode.replace(
    /<span className="text-2xl font-bold text-white\/90 group-hover:text-slate-800 transition-colors">/g,
...
console.log("Fixed Chinese buttons to slate-700");
