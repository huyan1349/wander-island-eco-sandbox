        ...
        <div className="pointer-events-auto w-[300px] max-w-[calc(100vw-2.5rem)] h-[400px] max-h-[60vh] flex flex-col hand-drawn-panel shadow-xl animate-in slide-in-from-bottom-2 fade-in duration-300 overflow-hidden" style={{ borderWidth: '2px', borderRadius: '2px' }}>
            ...
            {messages.map((msg) => {
              ...
              return (
                <div key={msg.id} className={`flex ${isMine ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[78%] px-3 py-2 text-[13px] leading-relaxed hand-drawn-panel ${isMine ? 'bg-emerald-50' : ''}`} style={{ borderWidth: '2px', borderRadius: '2px' }}>
          ...
          <div className="flex items-center gap-2 px-3 py-2.5 border-t-2 border-slate-800 shrink-0">
            <input
              ...
              style={{ borderWidth: '2px', borderRadius: '2px' }}
            />
